...
public class UserEJB {
    ...
    public void registerUser(String email, String firstName, String surname, String username, String password, String currency, BigDecimal balance) {
        try {
            ...
            Logger.getLogger(UserEJB.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    public SystemUser getLoggedInUser() {
        ...
        return getUserByUsername(currentUserUsername).get(0);
    }
